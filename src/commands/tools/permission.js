...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const role = await interaction.guild.roles.fetch('1026420689261056071').catch(console.error);
        ...
        // Has Role
        if (roles.cache.has('1026420689261056071')) {
            ...
            await interaction.reply({
                content :`You do not have the ${role.name}`
            }); 
        }
        ...
        await channel.permissionOverwrites.edit(testRole.id, { SendMessages: false })
        .catch(console.error)
    }
}